package com.example.neostore.cupboards
...
class Cupboards_Home:AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       /* toolbar.setOnClickListener{
        ...
        RetrofitClient.instancetable.getAllPhotos(product_category_id = "4" ,value = 4).enqueue( object :
